import { TIMETABLE_OPEN_BUTTON_SELECTOR, TIMETABLE_TABLE_SELECTOR, SEARCH_RESULTS_ROW_SELECTOR } from "./constants.js";
const readLessons = async (page, courses) => {
    const lessonLookup = Object.fromEntries(courses.map((cls) => [cls.code, []]));
